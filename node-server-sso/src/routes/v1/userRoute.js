...
// Private: API get user theo email (cần xác thực accessToken)
Router.route('/private/get_by_email/:email')
  .get(authMiddleware.auth0JwtCheck, userController.getByEmail)
